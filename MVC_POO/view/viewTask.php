                                    ...
                                    <div>
                                        ...
                                        <form action='' method='post'>
                                            ...
                                            <div class='col-md-12'>
                                                ...
                                                <textarea id='description' class='form-control shadow-sm p-3 mb-5 bg-white rounded' name='content_task' placeholder='Décrivez la tâche' rows='2' required></textarea>
                                            </div>
